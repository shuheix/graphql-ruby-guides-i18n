...
description: Subscription execution and delivery
sidebar:
  order: 3
---

The [`GraphQL::Subscriptions`](https://graphql-ruby.org/api-doc/GraphQL::Subscriptions) plugin is a base class for implementing subscriptions.

Each method corresponds to a step in the subscription lifecycle. See the API docs for method-by-method documentation: [`GraphQL::Subscriptions`](https://graphql-ruby.org/api-doc/GraphQL::Subscriptions).

Also, see the [Pusher implementation guide](subscriptions/pusher_implementation), the [Ably implementation guide](subscriptions/ably_implementation), the [ActionCable implementation guide](subscriptions/action_cable_implementation) or [`GraphQL::Subscriptions::ActionCableSubscriptions`](https://graphql-ruby.org/api-doc/GraphQL::Subscriptions::ActionCableSubscriptions) docs for an example implementation.
