---
title: Introduction
description: Implement fields and resolvers with the Ruby DSL
sidebar:
  order: 0
---
...
- `argument_details` (Interpreter only), an instance of [`GraphQL::Execution::Interpreter::Arguments`](https://graphql-ruby.org/api-doc/GraphQL::Execution::Interpreter::Arguments) with argument metadata
