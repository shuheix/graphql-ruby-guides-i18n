---
title: Resolvers
description: Reusable, extendable resolution logic for complex fields
sidebar:
  order: 2
redirect_from:
- "/fields/functions"
...
A [`GraphQL::Schema::Resolver`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Resolver) is a container for field signature and resolution logic. It can be attached to a field with the `resolver:` keyword:
...
Under the hood, [`GraphQL::Schema::Mutation`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Mutation) is a specialized subclass of `Resolver`.
