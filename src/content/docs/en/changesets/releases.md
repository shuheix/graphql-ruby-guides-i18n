...
description: Associating changes to version numbers
sidebar:
  order: 3
enterprise: true
---
...
To preview releases, you can create schema dumps by passing `context: { changeset_version: ... }` to [`Schema.to_definition`](https://graphql-ruby.org/api-doc/Schema.to_definition).
