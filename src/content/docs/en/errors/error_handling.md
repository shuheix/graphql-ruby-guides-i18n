...
description: Rescuing application errors from field resolvers
sidebar:
  order: 3
---
...
- __`field`__ is the [`GraphQL::Schema::Field`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Field) instance for the field where the error was rescued

Inside the handler, you can:

- Raise a GraphQL-friendly [`GraphQL::ExecutionError`](https://graphql-ruby.org/api-doc/GraphQL::ExecutionError) to return to the user
