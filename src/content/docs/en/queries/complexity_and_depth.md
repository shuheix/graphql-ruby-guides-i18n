...
description: Limiting query depth and field selections
sidebar:
  order: 4
---
...
To get a feeling for depth of queries in your system, you can extend [`GraphQL::Analysis::QueryDepth`](https://graphql-ruby.org/api-doc/GraphQL::Analysis::QueryDepth). Hook it up to log out values from each query:
...
To get a feeling for complexity of queries in your system, you can extend [`GraphQL::Analysis::QueryComplexity`](https://graphql-ruby.org/api-doc/GraphQL::Analysis::QueryComplexity). Hook it up to log out values from each query:
