---
title: Timeout
description: Cutting off GraphQL execution
sidebar:
  order: 5
---
...
To dynamically pick a timeout duration (or bypass it), override [`GraphQL::Schema::Timeout#max_seconds`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Timeout#max_seconds) in your subclass. To bypass the timeout altogether, `max_seconds` can return `false`.
