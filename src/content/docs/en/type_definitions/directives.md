---
title: Directives
description: Special instructions for the GraphQL runtime
sidebar:
  order: 10
---
...
- `@skip(if: ...)` skips the selection if the `if: ...` value is truthy ([`GraphQL::Schema::Directive::Skip`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Directive::Skip))
- `@include(if: ...)` includes the selection if the `if: ...` value is truthy ([`GraphQL::Schema::Directive::Include`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Directive::Include))

### Custom Runtime Directives

Custom directives extend [`GraphQL::Schema::Directive`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Directive):
...
[`GraphQL::Schema::Directive::Feature`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Directive::Feature) and [`GraphQL::Schema::Directive::Transform`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Directive::Transform) are included in the library as examples.
...
To make a custom schema directive, extend [`GraphQL::Schema::Directive`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Directive):
...
- IDL dumps (from [`Schema.to_definition`](https://graphql-ruby.org/api-doc/Schema.to_definition)) will include the configured directives

Similarly, [`Schema.from_definition`](https://graphql-ruby.org/api-doc/Schema.from_definition) parses directives from IDL strings.

For a couple of built-in examples, check out:

- [`GraphQL::Schema::Directive::Deprecated`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Directive::Deprecated) which implements `deprecation_reason` (via [`GraphQL::Schema::Member::HasDeprecationReason`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Member::HasDeprecationReason))
- [`GraphQL::Schema::Directive::Flagged`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Directive::Flagged), which is an example of using schema directives to implement [visibility](/authorization/visibility)
