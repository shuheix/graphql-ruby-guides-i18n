---
title: Visibility
description: Programmatically hide parts of the GraphQL schema from some users.
sidebar:
  order: 1
redirect_from:
...
[`GraphQL::Schema::Visibility`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Visibility) is a _new_ implementation of visibility in GraphQL-Ruby. It has some slight differences from the previous implementation ([`GraphQL::Schema::Warden`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Warden)):
