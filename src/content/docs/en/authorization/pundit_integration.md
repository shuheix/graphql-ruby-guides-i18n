...
description: Hook up GraphQL to Pundit policies
sidebar:
  order: 4
pro: true
---
...
When any Policy method returns `false`, the unauthorized object is passed to [`Schema.unauthorized_object`](https://graphql-ruby.org/api-doc/Schema.unauthorized_object), as described in [Handling unauthorized objects](/authorization/authorization#handling-unauthorized-objects).
