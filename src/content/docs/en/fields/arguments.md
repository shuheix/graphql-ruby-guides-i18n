---
title: Arguments
description: Fields may take arguments as inputs
sidebar:
  order: 1
---
...
- [`GraphQL::Schema::Scalar`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Scalar), including built-in scalars (string, int, float, boolean, ID)
- [`GraphQL::Schema::Enum`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Enum)
- [`GraphQL::Schema::InputObject`](https://graphql-ruby.org/api-doc/GraphQL::Schema::InputObject), which allows key-value pairs as input
- [`GraphQL::Schema::List`](https://graphql-ruby.org/api-doc/GraphQL::Schema::List)s of a valid input type, configured using `[...]`
- [`GraphQL::Schema::NonNull`](https://graphql-ruby.org/api-doc/GraphQL::Schema::NonNull)s of a valid input type (arguments are non-null by default; use `required: false` to make optional arguments)
