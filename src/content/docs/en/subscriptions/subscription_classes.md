...
description: Subscription resolvers for pushing updates to clients
sidebar:
  order: 1
---

You can extend [`GraphQL::Schema::Subscription`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Subscription) to create fields that can be subscribed to.
...
(This base class is a lot like the [mutation base class](/mutations/mutation_classes). They're both subclasses of [`GraphQL::Schema::Resolver`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Resolver).)
