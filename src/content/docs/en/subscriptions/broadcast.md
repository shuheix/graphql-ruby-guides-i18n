---
title: Broadcasts
description: Delivering the same GraphQL result to multiple subscribers
sidebar:
  order: 3
---
...
(See [`GraphQL::Subscriptions::Event#fingerprint`](https://graphql-ruby.org/api-doc/GraphQL::Subscriptions::Event#fingerprint) for the implementation of broadcast fingerprints.)

## Checking for Broadcastable

For testing purposes, you can confirm that a GraphQL query string is broadcastable by using [`Subscriptions#broadcastable?`](https://graphql-ruby.org/api-doc/Subscriptions#broadcastable?):
