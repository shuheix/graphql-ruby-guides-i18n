---
title: Overview
description: Introduction to Subscriptions in GraphQL-Ruby
sidebar:
  order: 0
---
...
[`GraphQL::Schema::Subscription`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Subscription) is a resolver class with subscription-specific behaviors. Each subscription field should be implemented by a subscription class.
