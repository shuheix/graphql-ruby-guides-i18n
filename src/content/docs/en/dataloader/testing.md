---
title: Testing
description: Tips for testing Dataloader implementation
sidebar:
  order: 4
---

There are a few techniques for testing your [`GraphQL::Dataloader`](https://graphql-ruby.org/api-doc/GraphQL::Dataloader) setup.
...
You can also test `Dataloader` behavior outside of GraphQL using [`GraphQL::Dataloader.with_dataloading`](https://graphql-ruby.org/api-doc/GraphQL::Dataloader.with_dataloading). For example, let's say you have a `Sources::ActiveRecord` source defined like so:
