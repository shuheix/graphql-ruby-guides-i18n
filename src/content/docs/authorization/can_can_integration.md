...
description: Hook up GraphQL to CanCan abilities
sidebar:
  order: 4
pro: true
---
...
When any CanCan check returns `false`, the unauthorized object is passed to [`Schema.unauthorized_object`](https://graphql-ruby.org/api-doc/Schema.unauthorized_object), as described in [Handling unauthorized objects](/authorization/authorization#handling-unauthorized-objects).
...
(See [`GraphQL::Schema::Field`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Field) for the different values available for defaults.)
