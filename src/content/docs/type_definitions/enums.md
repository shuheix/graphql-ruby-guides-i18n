---
title: Enums
description: Enums are sets of discrete values
sidebar:
  order: 2
---
...
In your application, enums extend [`GraphQL::Schema::Enum`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Enum) and define values with the `value(...)` method:
