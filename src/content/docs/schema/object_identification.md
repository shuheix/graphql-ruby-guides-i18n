...
description: Working with unique global IDs
sidebar:
  order: 8
---
...
To implement the node interface, add [`GraphQL::Types::Relay::Node`](https://graphql-ruby.org/api-doc/GraphQL::Types::Relay::Node) to your definition:
...
To add a UUID field named `"id"`, implement the [`GraphQL::Types::Relay::Node`](https://graphql-ruby.org/api-doc/GraphQL::Types::Relay::Node) interface::
