---
title: Generators
description: Use Rails generators to install GraphQL and scaffold new types.
sidebar:
  order: 3
---
...
- Enable [`ActiveRecord::QueryLogs`](https://api.rubyonrails.org/classes/ActiveRecord/QueryLogs.html) and add GraphQL-related metadata (using [`GraphQL::Current`](https://graphql-ruby.org/api-doc/GraphQL::Current))
