...
description: Resolvers can return "unfinished" results that are deferred for batch
  resolution.
sidebar:
  order: 4
---
...
- Connect it to your schema with [`GraphQL::Schema.lazy_resolve`](https://graphql-ruby.org/api-doc/GraphQL::Schema.lazy_resolve)
...
* [`GraphQL::Dataloader`](https://graphql-ruby.org/api-doc/GraphQL::Dataloader) is a built-in, Fiber-based approach to batching. See the [Dataloader guide](/dataloader/overview) for more information.
