---
title: Lookahead
description: Detecting child selections during field resolution
sidebar:
  order: 11
---

GraphQL-Ruby 1.9+ includes [`GraphQL::Execution::Lookahead`](https://graphql-ruby.org/api-doc/GraphQL::Execution::Lookahead) for checking whether child fields are selected. You can use this to optimize database access, for example, selecting only the _needed_ fields from the database.
