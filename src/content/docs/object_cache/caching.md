...
description: Configuration options for caching objects and fields
sidebar:
  order: 2
enterprise: true
---
...
If you're using [`GraphQL::Schema::Resolver`](https://graphql-ruby.org/api-doc/GraphQL::Schema::Resolver), you'd call `.items_for` slightly differently:
