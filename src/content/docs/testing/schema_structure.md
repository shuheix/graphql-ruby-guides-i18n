...
description: Make sure that your schema changes are backwards-compatible
sidebar:
  order: 1
---
...
You can read about this approach in ["Tracking Schema Changes with GraphQL-Ruby"](https://rmosolgo.github.io/ruby/graphql/2017/03/16/tracking-schema-changes-with-graphql-ruby) or the built-in [`GraphQL::RakeTask`](https://graphql-ruby.org/api-doc/GraphQL::RakeTask) for generating schema dumps.
