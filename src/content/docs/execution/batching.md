...
description: Background on GraphQL-Ruby's new execution approach
sidebar:
  order: 1
published: false
---

GraphQL-Ruby has a new execution module under development, [`GraphQL::Execution::Batching`](https://graphql-ruby.org/api-doc/GraphQL::Execution::Batching). It's not yet recommended for production use, but you can try it in development as described below.
...
1. Benchmark
   ...
   This is a good time to use your favorite benchmarking tools to see the payoff for your work. You could even use GraphQL-Ruby's own [`Tracing::DetailedTrace`](https://graphql-ruby.org/api-doc/Tracing::DetailedTrace), where GraphQL-Ruby overhead is essentially the blank space between spans.
