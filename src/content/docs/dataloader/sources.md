---
title: Sources
description: Batch-loading objects for GraphQL::Dataloader
sidebar:
  order: 1
---

_Sources_ are what [`GraphQL::Dataloader`](https://graphql-ruby.org/api-doc/GraphQL::Dataloader) uses to fetch data from external services.
...
If you load records from the database, you can use them to populate a source's cache by using [`Dataloader::Source#merge`](https://graphql-ruby.org/api-doc/Dataloader::Source#merge). For example:
