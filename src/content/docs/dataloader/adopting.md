...
description: Comparing and Contrasting Batch Loading Options
sidebar:
  order: 3
---

[`GraphQL::Dataloader`](https://graphql-ruby.org/api-doc/GraphQL::Dataloader) solves the same problem as [`GraphQL::Batch`](https://github.com/shopify/graphql-batch). There are a few major differences between the modules:
